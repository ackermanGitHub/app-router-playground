        ...
        <nav className="bottom-0 w-screen h-20 bg-[#93C6E7] dark:bg-[#393053] fixed mr-20 group border-r-2 z-10 min-[600px]:top-0 min-[600px]:w-20 min-[600px]:h-screen min-[600px]:hover:w-48 transition-all duration-300 ease-in-out">
            <ul className="flex flex-row justify-center min-[600px]:flex-col items-center h-full">
                        ...
                        >
                            <g className="fa-group">
                                <path
                                    ...
                                    className="text-[#222222] dark:text-[#ff7eee]"
                                ></path>
                                <path
                                    fill="currentColor"
                ...
                <li className="flex justify-center w-full last:mt-auto">
                    <Link href="/" className=" w-full text-[#111111] font-semibold hover:text-[#555555] dark:text-[#b6b6b6] dark:hover:text-[#ececec] hover:bg-[#FEDEFF] dark:hover:bg-[#18122B] flex items-center h-20 grayscale opacity-70 hover:opacity-100 hover:grayscale-0 transition-opacity duration-300 ">
                ...
                <li className="flex justify-center w-full last:mt-auto">
                    <Link href="/todos" className=" w-full text-[#111111] font-semibold hover:text-[#555555] dark:text-[#b6b6b6] dark:hover:text-[#ececec] hover:bg-[#FEDEFF] dark:hover:bg-[#18122B] flex items-center h-20 grayscale opacity-70 hover:opacity-100 hover:grayscale-0 transition-opacity duration-300">
                        ...
                        <svg width={30} height={30} className="min-w-[2rem] mx-[1.5rem] w-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path className="text-[#222222] dark:text-[#ff7eee]" d="M3 5.5L4 6.5L7 3.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                ...
                <li className="flex justify-center w-full last:mt-auto">
                    <Link href="images" className=" w-full text-[#111111] font-semibold hover:text-[#555555] dark:text-[#b6b6b6] dark:hover:text-[#ececec] hover:bg-[#FEDEFF] dark:hover:bg-[#18122B] flex items-center h-20 grayscale opacity-70 hover:opacity-100 hover:grayscale-0 transition-opacity duration-300">
                ...
                <li className="flex justify-center w-full last:mt-auto">
                    <div className="w-full text-[#111111] font-semibold hover:text-[#555555] dark:text-[#b6b6b6] dark:hover:text-[#ececec] hover:bg-[#FEDEFF] dark:hover:bg-[#18122B] flex items-center h-20 grayscale opacity-70 hover:opacity-100 hover:grayscale-0 transition-opacity duration-300 cursor-pointer">
                        <SignedIn>
                        ...
                        <SignedOut>
                            <Link className="flex items-center h-20" href="/sign-in">
...
/* 
                    ...
                    <a href="#" className=" w-full text-[#111111] font-semibold hover:text-[#555555] dark:text-[#b6b6b6] dark:hover:text-[#ececec] hover:bg-[#FEDEFF] dark:hover:bg-[#18122B] flex items-center h-20 grayscale opacity-70 hover:opacity-100 hover:grayscale-0 transition-opacity duration-300">
                        <svg
                            id="lightIcon"
                            aria-hidden="true"
                            focusable="false"
