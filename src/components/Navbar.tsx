...
const Navbar = () => {
    return (
        <nav className="bottom-0 w-screen h-20 bg-[#AAC8A7] dark:bg-[#26282B] fixed mr-20 group border-r-2 z-10 min-[600px]:top-0 min-[600px]:w-20 min-[600px]:h-screen min-[600px]:hover:w-48 transition-all duration-300 ease-in-out">
...
/* 
                    ...
                    <a href="#" className=" w-full text-[#111111] font-semibold hover:text-[#555555] dark:text-[#b6b6b6] dark:hover:text-[#ececec] hover:bg-[#FEDEFF] dark:hover:bg-[#0e151a] flex items-center max-[600px]:justify-center h-20 grayscale opacity-70 hover:opacity-100 hover:grayscale-0 transition-opacity duration-300">
                        <svg
                            id="lightIcon"
                            aria-hidden="true"
                            focusable="false"
