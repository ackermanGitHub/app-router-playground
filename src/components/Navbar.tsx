                ...
                <li className="justify-center w-full last:mt-auto">
                    <Link href="/todos" className=" text-[#b6b6b6] hover:text-[#ececec] hover:bg-[#141418] flex items-center h-20 grayscale opacity-70 hover:opacity-100 hover:grayscale-0 transition-opacity duration-300">
                        ...
                        <svg width={30} height={30} className="min-w-[2rem] mx-[1.5rem] w-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path className="text-[#ff7eee]" opacity="0.4" d="M11 12.5H21" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            <path className="text-[#ff7eee]" opacity="0.4" d="M11 5.5H21" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            <path className="text-[#ff7eee]" d="M3 5.5L4 6.5L7 3.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            <path className="text-[#ff7eee]" d="M3 12.5L4 13.5L7 10.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            <path className="text-[#ff7eee]" d="M3 19.5L4 20.5L7 17.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                ...
                <li className="justify-center w-full last:mt-auto">
                    <Link href="images" className=" text-[#b6b6b6] hover:text-[#ececec] hover:bg-[#141418] flex items-center h-20 grayscale opacity-70 hover:opacity-100 hover:grayscale-0 transition-opacity duration-300">
                        ...
                        <svg width={24} height={24} className="min-w-[2rem] mx-[1.5rem] w-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path className="text-[#ff7eee]" d="M9 10C10.1046 10 11 9.10457 11 8C11 6.89543 10.1046 6 9 6C7.89543 6 7 6.89543 7 8C7 9.10457 7.89543 10 9 10Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            <path className="text-[#ff7eee]" d="M2.67004 18.9501L7.60004 15.6401C8.39004 15.1101 9.53004 15.1701 10.24 15.7801L10.57 16.0701C11.35 16.7401 12.61 16.7401 13.39 16.0701L17.55 12.5001C18.33 11.8301 19.59 11.8301 20.37 12.5001L22 13.9001" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
...
/* 
                    ...
                    <a href="#" className=" text-[#b6b6b6] hover:text-[#ececec] hover:bg-[#141418] flex items-center h-20 grayscale opacity-70 hover:opacity-100 hover:grayscale-0 transition-opacity duration-300">
                        <svg
                            id="lightIcon"
                            aria-hidden="true"
                            focusable="false"
