    ...
    return (
        <footer className='w-full bg-gray-300 dark:bg-gray-800 text-center py-8'>
            ...
            <div className='grid grid-cols-2 min-[768px]:grid-cols-4 gap-4 p-4'>
                ...
                <Link href="#" className='text-gray-500 my-2'>Terms of Use</Link>
                <Link href="#" className='text-gray-500 my-2'>Contact Us</Link>
                <Link href="#" className='text-gray-500 my-2'>Help</Link>
                <Link href="#" className='text-gray-500 my-2'>About Us</Link>
                <Link href="#" className='text-gray-500 my-2'>Careers</Link>
                <Link href="#" className='text-gray-500 my-2'>Press</Link>
            </div>
